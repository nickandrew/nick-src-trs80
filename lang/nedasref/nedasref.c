...
char *fname;
{
   ...
   while (fgets(line,128,fp)!=NULL) {
      if (*line==0x1a) break; /* eof ... 1A byte trailer */
      ++inline;
      cp=line;
      *arg1=0;
      *arg2=0;
      ...
      if (*arg1=='*') {
         ...
         ltype="LABEL   ";
         if (!(strcmp(arg2,"DEFL") &&
               strcmp(arg2,"EQU"))) ltype="CONSTANT";
         if (!(strcmp(arg2,"DEFB") &&
               strcmp(arg2,"DB")))  ltype="BYTE    ";
         if (!(strcmp(arg2,"DEFW") &&
               strcmp(arg2,"DW")))  ltype="WORD    ";
          if (!(strcmp(arg2,"DEFM") &&
               strcmp(arg2,"DM")))  ltype="MESSAGE ";
        if (!(strcmp(arg2,"DEFS") &&
               strcmp(arg2,"DS")))  ltype="DEFS/buf";
        if (*arg2==0) ltype="   ??   ";
