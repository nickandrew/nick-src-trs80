;Unoffset/Edt: Remove Lm-offset induced faults
;from command files...
	ORG	5200H
STACK	DEFS	80H
UNOFF	LD	SP,UNOFF
...
ORORIG	DEFW	0
EOF	DEFW	0
SMESS	DEFM	'Insert Source disk, hit <C/R>'
	DEFB	0DH
DMESS	DEFM	'Insert Destination disk, hit <C/R>'
	DEFB	0DH
SGMESS	DEFM	'Unoffset/Cmd Ver 1.00 (01/03/84)'
	DEFB	0AH
	DEFM	'Removes lmoffset rubbish from files:'
	DEFB	0AH
	DEFM	'Use ONLY on files damaged by lmoffset'
	DEFB	0AH
	DEFM	'Copyright (C) 1984, Nick Andrew Z.M.S'
	DEFB	0AH
	DEFB	0DH
SIGNON	LD	HL,SGMESS
	CALL	4467H	;Mess>Display=4467H.
	RET
BCMD	LD	HL,COMBUFF
BCMV01	LD	A,(HL)
	CP	20H
