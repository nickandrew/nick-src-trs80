;pcat: Newdos version of Unix pcat utility
;
*GET	DOSCALLS
*GET	ASCII
;
...
;
	COM	'<Pcat version 0.1 - 21-Sep-86>'
	ORG	5300H
START	LD	SP,START
	LD	A,(HL)
	CP	CR
...
CHARACTERS	DC	256,'C'	;256 x char
;
...
M_USAGE	DEFM	'Usage: pcat filename',CR,0
M_ERR	DEFM	'pcat: could not unpack',CR,0
;
