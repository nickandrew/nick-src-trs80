program segmentation(input,output,lp,testdata);
(* LP=line printer, TESTDATA= file of random Nos. for test *)
...
begin (* main prog *)
   if test = 1 then rewrite(testdata);
   cptr:=1;
   fno:=1;
   free[1].where:=0;
